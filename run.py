...
try:
    ...
    3. Использование эмоджи (Сотруднику доступны только 🙁 🙂 😢 🤗 😁 😡 ✅ ❌ 👍): Проанализируй использование эмоджи только в ответе сотрудника. Если эмоджи улучшает ответ - Оценка: 5 или 4; Если использовались ухудшая/не улучшая ответ. Оценка: 2, 1 или 0; Если эмоджи отсутствуют - Оценка: 3} \n\
